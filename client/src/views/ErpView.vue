        ...
        <div v-if="showRecords" class="record-list">
          ...
          >
            ...
            <div class="record-desc">
              {{
                app.reason ||
                (app.formType === "leave" ? `请假 ${app.days} 天` : "")
              }}
            </div>
    ...
    <main class="erp-main">
      ...
      <div v-else class="approval-area">
        <div class="app-summary">
          ...
          <span v-if="erpStore.formType === 'expense' && erpStore.parsedForm"
            >{{ erpStore.parsedForm.reason }} · ¥{{
              erpStore.parsedForm.totalAmount
            }}</span
          >
          <span v-if="erpStore.formType === 'leave' && erpStore.parsedForm"
            >{{ erpStore.parsedForm.reason }} ·
            {{ erpStore.parsedForm.workdays }} 个工作日</span
          >
