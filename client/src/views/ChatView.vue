...
const currentRole = computed(
  () =>
    chatStore.roles.find((r) => r.id === chatStore.selectedRole) || {
      label: "通用助手",
      desc: "日常问答、通用任务",
    },
);
...
const roleIcon = computed(
  () => roleIconMap[chatStore.selectedRole] || "ChatDotRound",
);
...
const quickQuestions = computed(
  () => quickQuestionsMap[chatStore.selectedRole] || quickQuestionsMap.default,
);
