...
<template>
  <div class="approval-timeline">
    ...
    <div class="steps-panel">
      ...
      <!-- 审批等待中 loading -->
      <div
        v-if="erpStore.approving && !erpStore.approvalSteps.length"
        class="steps-loading"
      >
        <div class="spinner" />
        <span>正在安排审批流程...</span>
    ...
    <div class="conversation" ref="convEl">
      <!-- 空状态 -->
      <div
        v-if="!erpStore.approvalMessages.length && !erpStore.approving"
        class="conv-empty"
      >
